	...
	<div class="jumbotron">
		<div class="container text-center">
			<div class="img">
				...
				<img class="img-responsive" style="width:50%; display: inline-block;"
					src="http://www.moto-coach.de/wp-content/uploads/2018/05/rsv4.png">
			</div>
			<h1>Catalogo Moto Sportive</h1>
		</div>
	</div>


	<div class="table-responsive">
		<table class="table " ng-controller="myCtrl2">
			<thead>
				<tr>
					<th scope="col">Id</th>
			...
			<tbody>
				...
				<br>
				<tr data-ng-repeat="x in listMoto | filter:searchText">
					<td>{{ x.id}}</td>
					<td>{{ x.casaMoto }}</td>
					<td>{{ x.modello }}</td>
					<td>{{ x.colore }}</td>

	...
	<div class="jumbotron">
		<div class="container text-center">
			<div class="img">
				...
				<img class="img-responsive" style="width:45%; display: inline-block;"   
  
					src="https://www.piaggio.com/mediaObject/piaggio/master/global/models/gamma-liberty/piaggio-liberty-50-euro4/piaggio-liberty-50-euro4-DX-bianco/original/piaggio-liberty-50-euro4-DX-bianco.png">
			</div>
			<h1>Catalogo Motorini</h1>
		</div>
	</div>


	<div class="table-responsive">
		<table class="table " ng-controller="myCtrl4">
			<thead>
				<tr>
					<th scope="col">Id</th>
			...
			<tbody>
				...
				<br>
				<tr data-ng-repeat="x in listMotorino | filter:searchText">
					<td>{{ x.id}}</td>
					<td>{{ x.casaMotorino }}</td>
					<td>{{ x.modello }}</td>
					<td>{{ x.colore }}</td>
					<td>{{ x.stato }}</td>
					<td>{{ x.km|number }}</td>
